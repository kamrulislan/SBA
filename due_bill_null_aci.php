                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="date" class="form-control" data-target="#reservationdate" name="bil_date" />
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                $showsalesbill = "SELECT bil_num, bil_date,com_name,bil_amount,paid_bill_date FROM sale_statements WHERE com_name = 'ACI PHARMA' AND paid_bill_date IS NULL ORDER BY bil_num ASC";
                ...
                ?>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if ($customdateformatee) {
                                    echo date('M d,Y', strtotime($customdateformatee));
                                    //echo $customdateformatee;
                                } else {
                                    echo "Not applicable";
                                }
                                ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <?php
                        $billsum = "SELECT sum(bil_amount) FROM sale_statements WHERE com_name = 'ACI PHARMA' AND paid_bill_date IS NULL" or die(mysqli_error());
