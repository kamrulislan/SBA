            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        ...
                        <!-- Paid bill date -->
                        <div class="form-group">
                            <input type="hidden" name="paid_bill_date" value="None">
                        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $showsalesbill = "SELECT * FROM sales JOIN sales_bill ON sales.com_id=sales_bill.com_id ORDER BY bil_num desc";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="salecomadd-edit.php?bil_id=<?php echo $showsalesbilldata['bil_id']; ?>"
                                class="btn btn-primary">Edit</a>

                            <a href="salebilldel.php?bil_id=<?php echo $showsalesbilldata['bil_id'] ?>"><input
                                    type="submit" class="btn btn-danger" value="Delete"
                                    onclick="return confirmdel()"></a>
                        </td>
                    </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <?php
                        $billsum = "SELECT sum(bil_amount) FROM sales_bill" or die(mysqli_error());
