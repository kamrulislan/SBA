...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Edit Bill</h2>
                    ...
                    <form action="code.php" method="POST">
                        ...
                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bil_num" value="<?php echo $row['bil_num'] ?>" class="form-control" placeholder="Bill Number">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="bil_date" value="<?php echo $row['bil_date'] ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bil_amount" class="form-control" placeholder="Bill Amount" value="<?php echo $row['bil_amount'] ?>">
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="updatebilnumber" class="btn btn-info btn-block">Update</button>
                        </div>
                    </form>
                </div>
            </div>
