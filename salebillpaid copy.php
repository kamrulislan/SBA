    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $showsalesbill = "SELECT * FROM sales JOIN sales_bill ON sales.com_id=sales_bill.com_id ORDER BY bil_num asc";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="salebillpaid-edit.php?bil_id=<?php echo $showsalesbilldata['bil_id']; ?>"
