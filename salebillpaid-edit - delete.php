                ...
                <div class="col-md-6">
                    ...
                    <form action="code.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bil_num" disabled value="<?php echo $row['bil_num'] ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select name="com_id" id="" class="form-control" disabled>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bil_amount" disabled class="form-control" placeholder="Bill Amount"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                <input type="date" class="form-control" name="paid_bill_date"
                                    value="<?php echo $row['paid_bill_date'] ?>" />
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="updatepaidbillnumber"
