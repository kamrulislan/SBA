    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="" class="table table-bordered table-striped">
                ...
                $showsalesbill = "SELECT bil_num, bil_date,com_name,bil_amount,paid_bill_date FROM sale_statements WHERE com_name = 'ACI ANIMAL HEALTH' AND paid_bill_date IS NULL ORDER BY bil_num ASC";
                ...
                <tfoot>
                    <tr>
                        ...
                        <?php
                        $billsum = "SELECT sum(bil_amount) FROM sale_statements WHERE com_name = 'ACI ANIMAL HEALTH' AND paid_bill_date IS NULL" or die(mysqli_error());
