...
<div class="content-wrapper">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="com_type" id="" class="form-control">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="#" data-toggle="modal" data-target="#addusermodal" class="btn btn-primary float-right">Add Company
                name</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="salecom-edit.php?com_id=<?php echo $row['com_id']; ?>"
                                class="btn btn-primary">Edit</a>
                            <!--
                            <a href="deleteuser.php?com_id=<?php echo $row['com_id'] ?>"><input type="submit"
