    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                //$showlamsbill = "SELECT * FROM sales JOIN sales_bill ON sales.com_id=sales_bill.com_id ORDER BY bil_num asc";
                //$showlamsbill = "SELECT * FROM sale_statements";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php $formated_bill_amount = $showlamsbilldata['lam_bil_amount']; ?>
                        <td>
                        ...
                        <td>
                            <a href="lambillpaid-edit.php?lam_bil_id=<?php echo $showlamsbilldata['lam_bil_id']; ?>"
                ...
                <tfoot>
                    <tr>
                        ...
                        <?php
                        $billsum = "SELECT sum(lam_bil_amount) FROM lamination_bill" or die(mysqli_error());
