            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                        ...
                        $filter_data = "SELECT * FROM `exp_all` WHERE `exp_date` BETWEEN '$from_date' AND '$to_date'";
                        $filter_data_run = mysqli_query($conn, $filter_data);

                        if (mysqli_num_rows($filter_data_run) > 0) {
                            foreach ($filter_data_run as $filterdata) {
                                $filter_total = $filter_total
                                    + $filterdata['exp_amount'];
                    ?>


                    <tr>
                        <td><?php echo $filterdata['exp_date']; ?></td>
                        <td><?php echo $filterdata['cat_name']; ?></td>
                        <td><?php echo $filterdata['subcat_name']; ?></td>

                        <?php $filterdata_amount = $filterdata['exp_amount']; ?>
                        <td>
                            <?php
